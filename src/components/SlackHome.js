...
function SlackHome () {
  ...
  const createChannel = async(newChannelName) => {                   ////create channels
    const channelName  = newChannelName
    for (let i = 0; i<channels.length; i++){            ////ensure no duplicated channels
        if (channelName === channels[i].topic){
            setNotify({
                isOpen:true,
      ...
      <div className="home__container">
        <div className="channels__container">
          ...
          <div className="add-channel">
                   ...
                   <Popup createChannel = {createChannel}>
